...
def main(args_list=None) -> Tuple[List[str], Dict[str, List[str]]]:
    ...
    parser.add_argument('-d', '--dont-lint', action="append", default=[])
    ...
    while files_to_process_q:
        ...
        can_parse = current_file_has_tinyRV1 or current_file_has_ProcScycleCtrl or current_file_has_ProcScycleCtrl
